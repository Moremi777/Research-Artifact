...
func swap():
	...
	if iCount == 0:
		...
		pwTween.tween_property(cat, "position", Vector2(70, 350), 0.35)
	...
	# Lucky the Fish
		...
		peTween.tween_property(elephant, "position", Vector2(520, 410), 0.35)
		pcTween.tween_property(wolf, "position", Vector2(425 , 430), 0.35)
		phTween.tween_property(hippo, "position", Vector2(280, 430), 0.35)
		pwTween.tween_property(cat, "position", Vector2(140, 425), 0.35)
	...
	# Elephant and his shoe
		...
		# Move and scale each sprite to their respective positions and scales
		psTween.tween_property(snail, "position", Vector2(280, 440), 0.35)
		pwTween.parallel().tween_property(fish, "position", Vector2(170, 425), 0.35)
		prTween.tween_property(rabbit, "position", Vector2(100, 350), 0.35)
		peTween.tween_property(elephant, "position", Vector2(365, 220), 0.35)
		pcTween.tween_property(wolf, "position", Vector2(665, 350), 0.35)
		phTween.tween_property(hippo, "position", Vector2(570, 410), 0.35)
		pwTween.tween_property(cat, "position", Vector2(435, 450), 0.35)
	...
	# Wolf, Hyena and Fox 
		...
		psTween.tween_property(snail, "position", Vector2(425, 430), 0.35)
		pwTween.parallel().tween_property(fish, "position",  Vector2(290, 430), 0.35)
		prTween.tween_property(rabbit, "position", Vector2(150, 425), 0.35)
		peTween.tween_property(elephant, "position", Vector2(60, 350), 0.35)
		pwTween.tween_property(wolf, "position", Vector2(355, 239), 0.35)
		phTween.tween_property(hippo, "position", Vector2(650, 350), 0.35)
		pcTween.tween_property(cat, "position", Vector2(570, 410), 0.35)
		
		ssTween.tween_property(snail, "scale", Vector2(0.3, 0.33), 0.3)
		shTween.tween_property(hippo, "scale", Vector2(0.25, 0.25), 0.25)
		swTween.tween_property(wolf, "scale", Vector2(0.9, 0.9), 0.3)
		srTween.tween_property(rabbit, "scale", Vector2(0.25,0.25), 0.25)
		scTween.tween_property(cat, "scale", Vector2(0.3, 0.33), 0.3)
		sfTween.parallel().tween_property(fish, "scale", Vector2(0.3, 0.33), 0.3)
		seTween.tween_property(elephant, "scale", Vector2(0.3, 0.33), 0.3)
	...
	# Happy Hippo 
		...
		psTween.tween_property(snail, "position", Vector2(570, 410), 0.35)
		pwTween.parallel().tween_property(fish, "position", Vector2(455, 430), 0.35)
		prTween.tween_property(rabbit, "position", Vector2(295, 430), 0.35)
		peTween.tween_property(elephant, "position", Vector2(120, 425), 0.35)
		pcTween.tween_property(wolf, "position", Vector2(60, 350), 0.35)
		phTween.tween_property(hippo, "position", Vector2(355, 239), 0.35)
		pwTween.tween_property(cat, "position", Vector2(665, 350), 0.35)
	...
	# Cyber Cat
		...
		prTween.tween_property(rabbit, "position", Vector2(425, 430), 0.35)
		peTween.tween_property(elephant, "position", Vector2(270, 430), 0.35)
		pwTween.tween_property(wolf, "position", Vector2(155, 430), 0.35)
		phTween.tween_property(hippo, "position", Vector2(80, 350), 0.35)
